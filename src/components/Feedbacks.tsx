...
import { TestimonialCardInterface } from '../Interfaces';
  ...
  return (
    ...
    >
      ...
      <div className="mt-1">
        ...
        <div className='mt-7 flex justify-between items-center gap-10  xs:gap-1 flex-col xs:flex-row'>
          <div className='fñex flex-1 flex-col'>
            <p
